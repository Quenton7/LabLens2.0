  ...
  useEffect(() => {
    if (context && messages.length === 0) {
      ...
      setMessages([
        { 
          role: 'assistant', 
          content: `Hi ${name}! I am your Lab Interpreter. I have got your results ready. What specific questions do you have for me today?` 
        }
      ]);
    }
  }, [context]);
            ...
            >
              ...
              <div className="p-8 bg-[#1A237E] text-white flex justify-between items-center shadow-lg relative z-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-black uppercase tracking-tight">Lab Interpreter</h3>
                    <p className="text-[10px] opacity-60 font-black uppercase tracking-[0.2em]">Medical Logic AI</p>
                  </div>
                </div>
